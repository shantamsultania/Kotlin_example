...
This is an Android application in kotlin this is an minor example of intents.

##There are two Types of intents in Android Mainly.

### Implicit Intent..

This is used to share data from one activity to another.

### Explicit Intent.

This is used to share data from one activity to other platforms like web, gmail and etc
